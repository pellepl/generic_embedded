...
#define TRACE_TASK_MUTEX_WAIT(x)    TRACE_LOG(_TRC_TASK_MUTEX_WAIT, x)
#define TRACE_TASK_MUTEX_WAKE(x)    TRACE_LOG(_TRC_TASK_MUTEX_WAKE, x)
#define TRACE_TASK_MUTEX_EXIT(x)    TRACE_LOG(_TRC_TASK_MUTEX_EXIT, x)
#define TRACE_TASK_MUTEX_ENTER_M(x) TRACE_LOG(_TRC_TASK_MUTEX_ENTER_M, x)
#define TRACE_TASK_MUTEX_EXIT_L(x)  TRACE_LOG(_TRC_TASK_MUTEX_EXIT_L, x)
